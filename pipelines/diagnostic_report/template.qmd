...
params:
  model_dir_raw: "/home/xum8/pyrenew-hew/private_data/pyrenew-test-output/covid-19_r_2024-11-22_f_2024-08-19_t_2024-11-16/model_runs/CA/" # pragma: allowlist-secret
---
...
forecast_ci <- read_parquet(
  path(pyrenew_model_dir, "forecast_ci", ext = "parquet")
)
combined_dat <- read_parquet(
  path(pyrenew_model_dir, "combined_training_eval_data", ext = "parquet")
)
