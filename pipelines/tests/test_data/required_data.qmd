...
```{r}
dat$nhsn_data <- forecasttools::pull_nhsn(
  start_date = "2025-01-01",
  columns = "totalconfc19newadm",
  jurisdictions = c("CA", "MN")
) |>
  dplyr::mutate(weekendingdate = lubridate::as_date(weekendingdate)) |>
  dplyr::mutate(
    jurisdiction = dplyr::if_else(jurisdiction == "USA", "US", jurisdiction)
  ) |>
  dplyr::rename(hospital_admissions = "totalconfc19newadm") |>
