...
function create_sample_input(output_path::String; n_weeks::Int = 30,
    ...
    input_data = EpiAutoGPInput(
        dates, reports, pathogen, location, "nhsn", "epiweekly", false,
...
@testset "EpiAutoGPInput Tests" begin
    @testset "Construction and Serialization" begin
        ...
        input_data = EpiAutoGPInput(
            dates, reports, "COVID-19", "CA", "nhsn", "daily", false,
    ...
    @testset "Data Validation - Valid Cases" begin
        ...
        no_nowcast = EpiAutoGPInput(
            [Date("2024-01-01")], [10.0], "COVID-19", "TX", "nhsn", "daily", false,
    ...
    @testset "Data Validation - Invalid Cases" begin
        ...
        @test_throws ArgumentError validate_input(EpiAutoGPInput(
            ...
            "COVID-19", "CA", "nhsn", "daily", false, Date("2024-01-01"), Date[], Vector{Real}[]
        ))

        # Empty data
        @test_throws ArgumentError validate_input(EpiAutoGPInput(
            Date[], Real[], "COVID-19", "CA", "nhsn", "daily", false, Date("2024-01-01"), Date[], Vector{Real}[]
        ))

        # Unsorted dates
        @test_throws ArgumentError validate_input(EpiAutoGPInput(
            [Date("2024-01-02"), Date("2024-01-01")], [45.0, 52.0],
            "COVID-19", "CA", "nhsn", "daily", false, Date("2024-01-02"), Date[], Vector{Real}[]
        ))

        # Invalid nowcast structure
        @test_throws ArgumentError validate_input(EpiAutoGPInput(
            [Date("2024-01-01")], [45.0], "COVID-19", "CA", "nhsn", "daily", false, Date("2024-01-01"),
            [Date("2024-01-01")], [[50.0, 55.0]]  # Wrong length
        ))

        # Negative values
        @test_throws ArgumentError validate_input(EpiAutoGPInput(
            [Date("2024-01-01")], [-5.0], "COVID-19", "CA", "nhsn", "daily", false, Date("2024-01-01"), Date[], Vector{Real}[]
        ))
    end
